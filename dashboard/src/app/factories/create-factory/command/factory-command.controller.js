 ...
 */
export class FactoryCommandCtrl {
   ...
   */
  addCommand() {
    console.log('want to add command with name', this.commandLineName, 'and line', this.commandLine);
  ...
  editCommand($event, index) {
    ...
    console.log('want to edit index of commands', index, 'and value of command is', this.factoryObject.workspace.commands[index]);
    this.$mdDialog.show({
      targetEvent: $event,
      controller: 'FactoryCommandDialogEditCtrl',
